...
public:
    ...
    void from_rpm_fW_drive_odom(double rpm_fl, double rpm_bl, double rpm_fr, double rpm_br, rclcpp::Time & time);
    void from_rpm_diff_drive_odom(double rpm_l, double rpm_r, rclcpp::Time & time);
